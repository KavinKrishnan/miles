...
inference controller; the executor holds an ``EvalFleetSession`` over the wire and
...
class EvalFleetSession:
    ...
    def __init__(self, args: Namespace, *, info: EvalFleetInfo, inference_controller: BaseWorkerHandle) -> None:
